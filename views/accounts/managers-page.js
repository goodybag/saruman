define(function(require){
  ...
  , template          = require('hbt!./../../templates/accounts/managers-page')

  , Views = {
      Paginator       : require('../paginator')
    , ItemView        : require('./managers-list-item')
    }
  ...
  , initialize: function(options){
      ...
      troller.add('managers.setPage', function(page){
      ...
      this.paginator.on('change:page', function(){
        ...
        utils.history.navigate('/accounts/managers/page/' + (this_.currentPage + 1));
