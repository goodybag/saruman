define(function(require){
  ...
  return utils.Router.extend({
    ...
    , 'businesses/:bid/products/page/:page':              'businessProductsPaginate'
    , 'businesses/:bid/products/categories':              'businessProductCategories'
  ...
  , businessProductsPaginate: function(bid, pageNum){
      troller.app.changePage('business', { id: parseInt(bid), page: 'products' }, function(){
        troller.business.changePage('products', { pageNum: parseInt(pageNum) });
      });
    }

  , businessProductCategories: function(bid){
      troller.app.changePage('business', { id: parseInt(bid), page: 'product-categories' }, function(){
        troller.business.changePage('product-categories');
      });
    }
