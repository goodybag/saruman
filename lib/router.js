define(function(require){
  ...
  , businessLocations: function(id){
      Backbone.history.navigate('businesses/' + id + '/locations/page/1', { trigger: true });
    }

  , businessLocationsPaginate: function(id, page){
      pubsub.publish(channels.app.changePage.business, { id: parseInt(id), page: 'locations' });
      pubsub.publish(channels.business.changePage.locations, { page: parseInt(page) });
    }
  ...
  , businessLocationsEdit: function(bid, lid){
      ...
      console.log("sending locationId", lid);
