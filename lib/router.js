define(function(require){
  ...
  , businessesPaginate: function(page){
      troller.app.changePage('businesses', { page: parseInt(page) || 0, filter: {} }, function(){
        // Reset filter
        troller.businesses.filter({});
        troller.businesses.setPage(parseInt(page) || 0);
      });
    }

  , businessesVerified: function(page){
      troller.app.changePage('businesses', { page: parseInt(page) || 0, filter: { isVerified: true } }, function(){
        troller.businesses.filter({ isVerified: true });
        troller.businesses.setPage(parseInt(page) || 0);
      });
    }
