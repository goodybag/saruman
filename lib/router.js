define(function(require){
  ...
  , businessLoyalty: function(id){
      pubsub.publish(channels.app.changePage.business, { id: parseInt(id), page: 'loyalty' });
      pubsub.publish(channels.business.changePage.loyalty);
    }
  ...
  , businessLocationsPaginate: function(id, page){
      pubsub.publish(channels.app.changePage.business, { id: parseInt(id), page: 'locations', pageNum: page, page: 'locations' });
