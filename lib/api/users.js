define(function(require){
  ...
  , delete: function(id, callback){
      utils.api.update('v1/users/' + id, callback);
    }
  ...
  , consumers: {
    ...
    , delete: function(id, callback){
        utils.api.update('v1/consumers/' + id, callback);
      }
    }
  ...
  , sales: {
    ...
    , delete: function(id, callback){
        utils.api.update('v1/sales/' + id, callback);
      }
    }
  ...
  , tapinStations: {
    ...
    , delete: function(id, callback){
        utils.api.update('v1/tapin-stations/' + id, callback);
      }
    }
  ...
  , managers: {
    ...
    , delete: function(id, callback){
        utils.api.update('v1/managers/' + id, callback);
      }
    }
  ...
  , cashiers: {
    ...
    , delete: function(id, callback){
        utils.api.update('v1/cashiers/' + id, callback);
      }
    }
  };
});